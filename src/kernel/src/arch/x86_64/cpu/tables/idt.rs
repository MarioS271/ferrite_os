...
/// Build the IDT with all exception and IRQ handlers
pub fn idt_init() -> InterruptDescriptorTable {
    let mut idt = InterruptDescriptorTable::new();

    use crate::arch::x86_64::interrupts::{exceptions, irqs};
    use super::tss::{DEBUG_IST_STACK_INDEX, DOUBLE_FAULT_IST_STACK_INDEX, MACHINE_CHECK_IST_STACK_INDEX, NMI_IST_STACK_INDEX};
    ...
    // PIC IRQs
    idt[39].set_handler_fn(irqs::pic::irq7_spurious::handler);
